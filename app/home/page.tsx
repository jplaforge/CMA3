      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 md:py-32 lg:py-40 overflow-hidden">
          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tighter text-transparent bg-clip-text bg-gradient-to-r from-sky-400 via-sky-200 to-sky-400 mb-8 leading-tight">
